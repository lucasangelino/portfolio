    ...
    <Container maxW={"7xl"} mt={60}>
      ...
      >
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text color={"gray.500"}>
            Alguna vez usaste Twitter? Bueno, dejá de usarla porque la verdadera
      ...
      >
        ...
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text color={"gray.500"}>
            La mejor App de Pokemon de todos los tiempos! Realiza desafios y
            atrápalos todos! Colecciona tarjetas doradas y mucho mas! Creada con
            React, Node, MongoDB, Chakra UI, Vite y Vercel!
          </Text>
          <Stack
            spacing={{ base: 4, sm: 6 }}
            direction={{ base: "column", sm: "row" }}
